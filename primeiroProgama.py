...
s = n1 + n2 
#usando a função print para escrever e no meio chaves para ser colocado a função .format amostrando as vaiaveis de n1, n2 e a soma.
print('o resultado da soma do número {} e {} é {}!'.format(n1, n2, s))